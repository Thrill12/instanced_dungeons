...
public class Config {
        ...
        // public static final ModConfigSpec.ConfigValue<List<? extends Dungeon>> DUNGEONS = BUILDER
        // .comment("A list of dungeons to load").defineListAllowEmpty("dungeons",
        // List.of(Dungeon.createDungeon("test",
        // List.of("minecraft:stronghold"),
        // List.of("minecraft:zombie"))),
        // () -> null, Config::validateDungeon);
        ...
        // public static final ModConfigSpec.IntValue MAGIC_NUMBER = BUILDER.comment("A magic
        // number")
        ...
        // private static boolean validateDungeon(final Object obj) {
