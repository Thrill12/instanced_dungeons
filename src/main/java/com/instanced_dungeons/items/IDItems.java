...
public class IDItems {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, InstancedDungeonsMod.MODID);
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB =
            CREATIVE_MODE_TABS.register("instanced_dungeons",
                    () -> CreativeModeTab.builder()
                            .title(Component.translatable("itemGroup.instanced_dungeons")) // The
                                                                                           // language
                            // key for the
                            // title of your
                            // CreativeModeTab
                            .withTabsBefore(CreativeModeTabs.COMBAT)
                            .icon(() -> IDBlocks.EXAMPLE_BLOCK_ITEM.get().getDefaultInstance())
                            .displayItems((parameters, output) -> {
                                output.accept(IDBlocks.EXAMPLE_BLOCK_ITEM.get());// Add the example
                                                                                 // block
                                // item to the
